  ...
  return (
    <div className="my-8 mx-16 lg:mx-6 lg:my-8 flex flex-col items-center lg:items-start">
      ...
      <span className="text-base flex flex-col gap-3 lg:text-xl w-full">
        ...
        <p>
          Полное наименование: ОБЩЕРОССИЙСКАЯ ОБЩЕСТВЕННАЯ ОРГАНИЗАЦИЯ
          СОДЕЙСТВИЯ РАЗВИТИЮ ПСИХОТЕРАПЕВТИЧЕСКОЙ ПРАКТИКИ И НАУКИ "РОССИЙСКАЯ
          ПСИХОТЕРАПЕВТИЧЕСКАЯ АССОЦИАЦИЯ СПЕЦИАЛИСТОВ И ОРГАНИЗАЦИЙ В ОБЛАСТИ
